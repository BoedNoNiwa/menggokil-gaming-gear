  ...
  return (
    <div className='cart-wrapper' ref={cartRef}>
      <div className='cart-container'>
        <button type='button' className='cart-heading' onClick={() => setShowCart(prevShowCart => !prevShowCart)}>
          <AiOutlineLeft />
        ...
        {cartItems.length < 1 && (
          <div className='empty-cart'>
            ...
            <Link href='/'>
              <button type='button' onClick={() => setShowCart(prevShowCart => !prevShowCart)} className="btn">
                Continue Shopping
              </button>
            </Link>
          </div>
